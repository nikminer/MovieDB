    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following', models.ManyToManyField(related_name='followers', through='Profile.Follower', to='Profile.Profile')),
        ...
        migrations.AddField(
            model_name='follower',
            name='follow_from',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rel_from_set', to='Profile.Profile'),
        ),
        migrations.AddField(
            model_name='follower',
            name='follow_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rel_to_set', to='Profile.Profile'),
        ),
        migrations.CreateModel(
            name='Feed',
            fields=[
